/** The user's browser locale string, falling back to `'en-EN'`. */
export const locale:string = navigator?.language ?? 'en-EN';

/** `Intl.DisplayNames` instance for resolving language names in the user's locale, or `undefined` if unsupported. */
...
/** Checks whether a language code is a right-to-left language. */
