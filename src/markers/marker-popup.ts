...
micrio-marker-popup {
	...
	animation: micrio-popup-in .2s ease-out;
}
micrio-marker-popup>* {
	pointer-events: auto;
}
@keyframes micrio-popup-in {
	from {
		opacity: 0;
...
micrio-marker-popup.destroying {
	animation: none;
	opacity: 0;
	transform: translateX(-50px);
	pointer-events: none;
...
micrio-marker-popup>aside {
	padding: var(--micrio-border-margin);
}
micrio-marker-popup>aside progress {
	display: none;
}
@media (min-width: 501px) {
	...
	micrio-marker-popup>aside>.micrio-button {
		padding: 0;
		margin: 0 0 8px 0;
		display: block;
	}
...
@media (max-width: 500px) {
	...
	micrio-marker-popup>aside .micrio-tour-controls {
