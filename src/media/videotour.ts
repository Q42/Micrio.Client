...
export class VideoTourInstance {
	...
	destroy() : void {
		...
		this.#data.instance = undefined; // Remove instance reference from data
	...
	#getView(i:number) : Models.Camera.View|undefined {
