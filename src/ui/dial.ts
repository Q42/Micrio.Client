...
micrio-dial::before{height:50%;top:25%;background-image:repeating-linear-gradient(to right,#8888 0%,#8888 0.5%,transparent 1%,transparent 2.5%)}
micrio-dial::after{height:100%;background-image:repeating-linear-gradient(to right,#fff8 0%,#fff8 0.5%,transparent 1%,transparent 20%)}`;
